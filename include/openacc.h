...
extern size_t acc_get_property(int devicenum, acc_device_t devicetype,
                               acc_device_property_t property); // 3.2.6
extern const char *
acc_get_property_string(int devicenum, acc_device_t devicetype,
                        acc_device_property_t property);               // 3.2.6
...
extern void acc_copyin_async(h_void *a, size_t len, int async);        // 3.2.26
extern d_void *acc_create(h_void *a, size_t len);                      // 2.3.27
extern void acc_create_async(h_void *a, size_t len, int async);        // 2.3.27
extern void acc_copyout(h_void *a, size_t len);                        // 3.2.28
extern void acc_copyout_async(h_void *a, size_t len, int async);       // 3.2.28
extern void acc_copyout_finalize(h_void *a, size_t len);               // 3.2.28
extern void acc_copyout_finalize_async(h_void *a, size_t len,          // 3.2.28
                                       int async);                     // 3.2.28
extern void acc_delete(h_void *a, size_t len);                         // 3.2.29
extern void acc_delete_async(h_void *a, size_t len, int async);        // 3.2.29
extern void acc_delete_finalize(h_void *a, size_t len);                // 3.2.29
extern void acc_delete_finalize_async(h_void *a, size_t len,           // 3.2.29
                                      int async);                      // 3.2.29
extern void acc_update_device(h_void *a, size_t len);                  // 3.2.30
extern void acc_update_device_async(h_void *a, size_t len, int async); // 3.2.30
extern void acc_update_self(h_void *a, size_t len);                    // 3.2.31
extern void acc_update_self_async(h_void *a, size_t len, int async);   // 3.2.31
...
extern void acc_memcpy_to_device(d_void *dest, h_void *src,            // 3.2.36
                                 size_t bytes);                        // 3.2.37
extern void acc_memcpy_to_device_async(d_void *dest, h_void *src, size_t bytes,
                                       int async); // 3.2.37
extern void acc_memcpy_from_device(h_void *dest, d_void *src,
                                   size_t bytes); // 3.2.38
extern void acc_memcpy_from_device_async(h_void *dest, d_void *src,
                                         size_t bytes, int async); // 3.2.38
extern void acc_memcpy_device(d_void *dest, d_void *src,
                              size_t bytes); // 3.2.39
extern void acc_memcpy_device_async(d_void *dest, d_void *src, size_t bytes,
                                    int async);                 // 3.2.39
extern void acc_attach(h_void **ptr);                           // 3.2.40
extern void acc_attach_async(h_void **ptr, int async);          // 3.2.40
extern void acc_detach(h_void **ptr);                           // 3.2.41
extern void acc_detach_async(h_void **ptr, int async);          // 3.2.41
extern void acc_detach_finalize(h_void **ptr);                  // 3.2.41
extern void acc_detach_finalize_async(h_void **ptr, int async); // 3.2.41
extern void acc_memcpy_d2d(h_void *dst, h_void *src, size_t sz, int dstdev,
                           int srcdev); // 3.2.42
extern void acc_memcpy_d2d_async(h_void *dst, h_void *src, size_t sz,
